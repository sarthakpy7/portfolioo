            ...
            <Heading className={emailClasses}>
              <div>
                <div className={style.emailContainer}>
                  <a className={style.email} href="mailto:sarthak.singhallen@gmail.com">
          ...
          <ContentBlock>
            <div>
              <ul className={style.list}>
                <li>
                  <a
                    href="https://www.linkedin.com/in/sarthak-singh-718901259/"
                    onMouseEnter={overHandler}
                    onMouseLeave={outHandler}
                    target="_blank"
                  >
                ...
                <li>
                  <a
                    href="https://github.com/sarthakpy7"
                    onMouseEnter={overHandler}
                    onMouseLeave={outHandler}
                    target="_blank"
                  >
